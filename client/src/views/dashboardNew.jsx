...
const ContributeNew = props => {
  ...
  const DashboardIcon = () => (
    <svg width="202" height="202" className={""} viewBox="0 0 202 202" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M169.835 28.3467H19.5569C8.77319 28.3467 0 37.1199 0 47.904V50.5568C0 61.3405 8.77319 70.1137 19.5569 70.1137H169.836C171.475 70.1137 172.803 68.7857 172.803 67.1469V31.3136C172.803 29.6747 171.475 28.3467 169.835 28.3467Z"
        fill="#BB98EA"
      />
      <path
        d="M0.809973 42.3438C0.285641 44.1073 0 45.9719 0 47.9039V50.5567C0 61.3404 8.77319 70.1136 19.5569 70.1136H169.836C171.475 70.1136 172.803 68.7856 172.803 67.1467V56.3299H19.5569C10.6918 56.3295 3.20912 50.4297 0.809973 42.3438Z"
        fill="#8B49DB"
      />
      <path
        d="M94.5647 19.2232L83.2933 7.95225C82.1349 6.79391 80.2562 6.79391 79.0971 7.95225L22.0013 65.048C21.1526 65.8971 20.8989 67.1726 21.3586 68.2816C21.8174 69.3906 22.9 70.1134 24.0998 70.1134H46.6421C47.4288 70.1134 48.1835 69.801 48.7402 69.2447L94.565 23.4199C95.1213 22.8632 95.4338 22.1088 95.4338 21.3217C95.4338 20.5346 95.1209 19.7803 94.5647 19.2232Z"
        fill="#78AA17"
      />
      <path
        d="M30.5843 56.4648L22.0013 65.0479C21.1526 65.8969 20.8989 67.1724 21.3586 68.2815C21.8174 69.3905 22.9 70.1133 24.0998 70.1133H46.6421C47.4288 70.1133 48.1835 69.8008 48.7402 69.2445L61.5195 56.4652H30.5843V56.4648Z"
        fill="#6D8915"
      />
      <path
        d="M162.931 65.048L105.836 7.95225C104.677 6.79391 102.798 6.79391 101.639 7.95225L44.5437 65.048C43.6951 65.8971 43.4414 67.1726 43.9011 68.2816C44.3599 69.3906 45.4425 70.1134 46.6423 70.1134H160.834C162.034 70.1134 163.116 69.3906 163.575 68.2816C164.033 67.1726 163.78 65.8967 162.931 65.048Z"
        fill="#8ACC19"
      />
      <path
        d="M44.5437 65.0479C43.6951 65.8969 43.4414 67.1724 43.9011 68.2815C44.3599 69.3905 45.4425 70.1133 46.6423 70.1133H160.834C162.034 70.1133 163.116 69.3905 163.575 68.2815C164.034 67.1724 163.781 65.8969 162.932 65.0479L154.349 56.4648H53.1268L44.5437 65.0479Z"
        fill="#78A017"
      />
      <path
        d="M146.183 65.3146L114.484 33.6149C113.927 33.0586 113.172 32.7461 112.386 32.7461C111.599 32.7461 110.845 33.0586 110.287 33.6149C108.583 35.32 106.316 36.259 103.905 36.259C101.494 36.259 99.2276 35.3204 97.5228 33.6152C96.9665 33.0586 96.2118 32.7461 95.4247 32.7461C94.6376 32.7461 93.8832 33.0586 93.3265 33.6149L61.6268 65.3146C60.7781 66.1637 60.5244 67.4392 60.9841 68.5482C61.4429 69.6573 62.5255 70.38 63.7253 70.38H144.085C145.285 70.38 146.368 69.6573 146.827 68.5482C147.285 67.4392 147.031 66.1633 146.183 65.3146Z"
        fill="#78A017"
      />
      <path
        d="M61.5042 65.0479C60.6556 65.8969 60.4019 67.1724 60.8615 68.2815C61.3203 69.3905 62.4029 70.1133 63.6027 70.1133H143.963C145.163 70.1133 146.245 69.3905 146.704 68.2815C147.163 67.1724 146.91 65.8969 146.061 65.0479L137.478 56.4648H70.0868L61.5042 65.0479Z"
        fill="#6D8915"
      />
      <path
        d="M188.272 64.1793H47.1165H20.8833H16.0448C7.5245 64.1793 0.5555 57.5515 0.00315625 49.1709C0.00276172 49.1906 0 49.2104 0 49.2313V49.2317V174.034C0 185.549 9.36814 194.917 20.8833 194.917H188.272C189.911 194.917 191.239 193.589 191.239 191.95V67.1461C191.239 65.5077 189.911 64.1793 188.272 64.1793Z"
        fill="#BB98EA"
      />
      <path
        d="M191.239 115.142H159.304C147.376 115.142 137.671 124.846 137.671 136.775C137.671 148.702 147.375 158.407 159.304 158.407H191.239V115.142Z"
        fill="#8B49DB"
      />
      <path
        d="M193.099 107.522H159.303C147.376 107.522 137.671 117.226 137.671 129.155C137.671 141.082 147.375 150.787 159.303 150.787H193.099C198.007 150.787 202 146.794 202 141.886V116.423C202 111.515 198.007 107.522 193.099 107.522Z"
        fill="#A06CE2"
      />
      <path
        d="M161.816 119.475C156.48 119.475 152.138 123.817 152.138 129.154C152.138 134.49 156.48 138.832 161.816 138.832C167.152 138.832 171.495 134.49 171.495 129.154C171.495 123.817 167.152 119.475 161.816 119.475Z"
        fill="#F0E6FA"
      />
      <path
        d="M102.86 145.751C97.6735 145.751 93.3436 149.322 92.0965 154.121H77.7508C74.6736 154.121 72.171 151.618 72.171 148.541V131.802H92.0965C93.3436 136.6 97.6735 140.171 102.86 140.171C109.014 140.171 114.02 135.166 114.02 129.012C114.02 122.857 109.014 117.852 102.86 117.852C97.6735 117.852 93.3436 121.423 92.0965 126.222H72.171V109.482C72.171 103.328 67.166 98.3228 61.0114 98.3228H57.8254C56.5783 93.5242 52.2484 89.9531 47.0619 89.9531C40.9074 89.9531 35.9023 94.9582 35.9023 101.113C35.9023 107.267 40.9074 112.272 47.0619 112.272C52.2484 112.272 56.5783 108.701 57.8254 103.903H61.0114C64.0887 103.903 66.5912 106.405 66.5912 109.482V148.541C66.5912 154.696 71.5963 159.701 77.7508 159.701H92.0965C93.3436 164.499 97.6735 168.07 102.86 168.07C109.014 168.07 114.02 163.065 114.02 156.911C114.02 150.756 109.014 145.751 102.86 145.751ZM102.86 123.432C105.937 123.432 108.44 125.934 108.44 129.012C108.44 132.089 105.937 134.592 102.86 134.592C99.7827 134.592 97.2801 132.089 97.2801 129.012C97.2801 125.934 99.7827 123.432 102.86 123.432ZM47.0619 106.693C43.9847 106.693 41.4821 104.19 41.4821 101.113C41.4821 98.0355 43.9847 95.5329 47.0619 95.5329C50.1392 95.5329 52.6417 98.0355 52.6417 101.113C52.6417 104.19 50.1392 106.693 47.0619 106.693ZM102.86 162.491C99.7827 162.491 97.2801 159.988 97.2801 156.911C97.2801 153.833 99.7827 151.331 102.86 151.331C105.937 151.331 108.44 153.833 108.44 156.911C108.44 159.988 105.937 162.491 102.86 162.491Z"
        fill="white"
      />
    </svg>
  );
  ...
  useEffect(async () => {
    document.title = `iHelp | Dashboard (${
      ...
      setTimeout(() => {
        ...
        const processUserStats = async () => {
          ...
          for (let i = index; i < numberOfCharities; i = i + BATCH_SIZE) {
            ...
            const d = await props.readContracts["analytics"]["userStats"](
              props.readContracts["iHelp"].address,
              props.address,
              i,
              BATCH_SIZE,
            );
        ...
        const processCharityBatches = async () => {
          ...
          for (let i = index; i < numberOfCharities; i = i + BATCH_SIZE) {
            ...
            const d = await props.readContracts["analytics"]["getUserContributionsPerCharity"](
              props.readContracts["iHelp"].address,
              props.address,
              i,
              BATCH_SIZE,
  ...
  const charityColumns = [
      ...
      render: c => {
        ...
        c.map(cc => {
          ...
          objs.push(
            <Tooltip title={ccci}>
              <img
                src={`/assets/icons/${ccci.replace(".e", "")}.svg`}
                style={{ marginTop: "0px", height: "20px", marginRight: "10px", display: "inline" }}
              />
              {charityDecimals ? commafy(parseFloat(utils.formatUnits(cccd, charityDecimals[ccci])).toFixed(2)) : ""}
              <br />
            </Tooltip>,
          );
        });
    ...
    },
    {
      ...
      key: "directdonations",
      render: c =>
        `${charityDecimals ? "$" + commafy(parseFloat(utils.formatUnits(c, charityDecimals["DAI"])).toFixed(2)) : ""}`,
      sorter: (a, b) => a["contributed"] - b["contributed"],
      sortDirections: ["ascend", "descend"],
      // width: '10%',
    },
    {
      ...
      render: c => {
        return (
          <Tooltip title={`Go to Charity ${c}`}>
            <div>
              <button
                className="grd-btn"
                onClick={e => {
                  history.push("/charity/" + c);
                }}
              >
                Adjust
              </button>
            ...
            <div className="body">
              <div className="contributionsContent" style={{ textAlign: "center" }}>
                ...
                <div style={{ padding: "2.4rem", width: "33%", display: "inline-block", textAlign: "center" }}>
                  <p>Yield Generated</p>
                  <h5>
                    {totalInterestGenerated || totalInterestGenerated == 0 ? (
                      `$${commafy(totalInterestGenerated.toFixed(2))}`
                    ) : (
                      <Spin />
                    )}
                  </h5>
                ...
                <div style={{ padding: "2.4rem", width: "33%", display: "inline-block", textAlign: "center" }}>
                  ...
                  <h5>
                    {directDonations || directDonations == 0 ? `$${commafy(directDonations.toFixed(2))}` : <Spin />}
                  </h5>
                </div>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <XAxis
                        ...
                        dataKey="time"
                        domain={["auto", "auto"]}
                        tickFormatter={timeStr => moment(timeStr).format("M-D-H")}
                      />
                      <YAxis
                        tick={{ fontSize: 7 }}
                        type="number"
                        dataKey="contrib"
                        domain={["auto", "auto"]}
                        tickFormatter={yStr => "$" + commafy(yStr.toFixed(0))}
                      />
                      <ChartTooltip />
                      <Legend />
                      <Scatter
              ...
              <div className="rewardsContent" style={{ textAlign: "center" }}>
                ...
                <div>
                  ...
                  <h5>
                    {claimableHelpTokens ? (
                      commafy(parseFloat(utils.formatUnits(claimableHelpTokens, 18)).toFixed(2))
                    ) : (
                      <Spin />
                    )}
                  </h5>
                  <button onClick={handleClaimTokens} disabled={claimableHelpTokens > 0 ? false : true}>
                    CLAIM HELP TOKENS
                  </button>
                </div>
                <div style={{ textAlign: "center" }}>
                  <ul>
                    <li>
                      <p>
                        HELP Balance{" "}
                        <a style={{ fontStyle: "italic" }} onClick={handleTokenAdd}>
                          add
                        </a>
                      </p>
                      <h5>
                        {ihelpBalance ? commafy(parseFloat(utils.formatUnits(ihelpBalance, 18)).toFixed(2)) : <Spin />}
                      </h5>
                    </li>
                    <li>
                      <p>xHELP Balance</p>
                      <h5>
                        {xhelpBalance ? commafy(parseFloat(utils.formatUnits(xhelpBalance, 18)).toFixed(2)) : <Spin />}
                      </h5>
                    </li>
                  </ul>
                  <button
                    style={{ color: "#5C0FC5", backgroundColor: "transparent" }}
                    onClick={e => {
                      history.push("/stake");
                    }}
                  >
                    ADJUST STAKING POSITIONS
                  </button>
                </div>
              </div>
              ...
              <h6>All Time Ranking: 5th</h6>*/}
                ...
                <button
                  ...
                  disabled={contribTotal && contribTotal > 0 ? false : true}
                >
                  WITHDRAW ALL
                </button>
              </div>
          ...
          <div className={st.tableGrid}>
            ...
            <div className={st.tableContainer}>
              ...
              <div className={st.dashboardTable + " " + "table"}>
                <Table
                  className={st.tableContribute + " " + "table"}
