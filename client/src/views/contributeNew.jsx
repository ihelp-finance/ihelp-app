...
//     <path
//       d="M60.5028 6.52588L34.332 34.9145L35.049 47.9139L65.3139 20.9819C65.3139 20.755 65.3426 20.5244 65.3498 20.2938C65.5469 15.2361 63.8086 10.2985 60.5028 6.52588Z"
//       fill="#8E40DA"
//     />
//     <path
//       d="M8.09663 3.57959C7.21158 4.22008 6.38053 4.935 5.6122 5.71688C5.17841 6.16337 4.76613 6.62816 4.37895 7.10393C2.54421 9.369 1.23635 12.0292 0.553711 14.8845L30.3848 40.6345L31.2309 27.7595L8.09663 3.57959Z"
//       fill="#8830EF"
//     />
//     <path
//       d="M60.4986 6.52573C60.262 6.25125 60.0146 5.9841 59.7565 5.7206C59.4984 5.45709 59.2402 5.21188 58.9749 4.96668C55.328 1.64183 50.573 -0.132469 45.6853 0.00771667C40.7977 0.147903 36.1478 2.19195 32.6895 5.7206L34.0733 30.3507L60.4986 6.52573Z"
//       fill="#B559F7"
//     />
//     <path
//       d="M10.0792 2.32444C9.39451 2.70227 8.73249 3.12145 8.09668 3.57974L31.4747 24.034L32.6793 5.73533C29.7713 2.76323 26.0028 0.82652 21.9321 0.212159C17.8615 -0.402202 13.7052 0.338472 10.0792 2.32444Z"
//       fill="#AC6EF4"
//     />
//     <path
//       d="M35.2988 52.3418L35.6143 57.9998L59.7559 33.3551C62.9878 30.0662 64.9569 25.7031 65.3056 21.0583C65.3038 21.0352 65.3038 21.0119 65.3056 20.9888L35.2988 52.3418Z"
//       fill="#5C1AA8"
//     />
//     <path
//       d="M0.549778 14.8882L0.506754 15.0858C-0.238276 18.3225 -0.160683 21.6998 0.732159 24.8972C1.625 28.0946 3.30347 31.0061 5.60826 33.3553L29.2695 57.5096L30.0941 45.0006L0.549778 14.8882Z"
//       fill="#560AC1"
//     />
//   </svg>
// );
...
//   const [filteredShownCharities, setFilteredShownCharities] = useState(CARDS_TO_SHOW);
...
//   useEffect(async () => {
//     document.title = `iHelp | Contribute (${
...
//           const d = await props.readContracts["analytics"]["generalStats"](
...
//       key: "category",
//       sorter: (a, b) =>
//         a["Charity GENERAL Category (One Cell)"].localeCompare(b["Charity GENERAL Category (One Cell)"]),
//       sortDirections: ["ascend", "descend"],
//       width: "25%",
...
//     setFilteredShownCharities(filteredShownCharities + CARDS_TO_SHOW);
//   };
...
//         const key = [
//           c["Organization Name"],
//           c["Charity GENERAL Category (One Cell)"],
//           c["Brief Description & History"],
//         ].join(",");
//         if (key.toLowerCase().indexOf(searchValue.toLowerCase()) > -1 && c["Status"] == "LIVE") {
//           searchpass = true;
//         }
...
//           if (
//             paramMap[cc][1](
//               parseFloat(c[paramMap[cc][0]].replace(/,/g, "").replace(/\$/g, "")),
//               parseFloat(filteredParams[cc]),
//             )
//           ) {
//             passes.push(true);
//           } else {
...
//       content: (
//         <CheckboxContainer
//           data={filteredParams.categories}
//           onHandleChange={handleCategoryCheckboxChange}
//           seeMore={true}
//         />
//       ),
//     },
...
//       content: (
//         <CheckboxContainer
//           data={filteredParams.geography}
//           onHandleChange={handleGeographyCheckboxChange}
//           seeMore={true}
//         />
//       ),
//     },
...
//               type="number"
//               placeholder="0"
//               value={filteredParams["revenue_min"]}
//               name="revenue_min"
...
//               type="number"
//               placeholder="999.999"
//               value={filteredParams["revenue_max"]}
//               name="revenue_max"
//               onChange={updateFilterParams}
//             />
//           </div>
...
//               type="number"
//               placeholder="0"
//               value={filteredParams["prog_exp_rev_min"]}
//               name="prog_exp_rev_min"
//               onChange={updateFilterParams}
//             />
//             <input
//               type="number"
//               placeholder="100"
//               value={filteredParams["prog_exp_rev_max"]}
//               name="prog_exp_rev_max"
//               onChange={updateFilterParams}
//             />
//           </div>
//           <div className="inputBanner">
...
//               type="number"
//               placeholder="2000"
//               value={filteredParams["year_inc_min"]}
//               name="year_inc_min"
//               onChange={updateFilterParams}
//             />
//             <input
//               type="number"
//               placeholder="2022"
//               value={filteredParams["year_inc_max"]}
//               name="year_inc_max"
//               onChange={updateFilterParams}
//             />
//           </div>
...
//               <div className={"quickInfoSub"}>{tvl == "" ? <Spin /> : `$${tvl}`}</div>
//               <p>Total Value Locked (TVL)</p>
//             </div>
//             <div className={"quickInfo"}>
//               <img src={generated_light} alt="logo" className="quickInfoIcon" />
//               <div className={"quickInfoSub"}>{totalInterest == "" ? <Spin /> : `$${totalInterest}`}</div>
...
//               <div className={"quickInfoSub"}>{totalCharities == "" ? <Spin /> : totalCharities}</div>
//               <p>Total Charities</p>
//             </div>
//           </div>
...
//                 <button onClick={applyFilteredParams} disabled={filtersMatch ? "disabled" : false}>
//                   Apply
//                 </button>
...
//                 Found {filteredCharities.length} out of {allCharities.length} total charities...
//               </span>
...
//                           <p className="kseName">{item["Organization Name"]} </p>

//                           <div className="keyDataBanner">
//                             {item["Video for Charity Card"] && item["Video for Charity Card"] != "" ? (
//                               <iframe
//                                 className="infoVideo"
//                                 height={"200px"}
//                                 width={"400px"}
...
//                                   item["Video for Charity Card"] && item["Video for Charity Card"] != ""
//                                     ? getVideoId(item["Video for Charity Card"].split("\n")[0])
//                                     : ""
//                                 }`}
//                                 title=""
//                                 frameBorder="0"
...
//                               <span
//                                 className="infoVideo"
//                                 style={{ marginTop: "20px", width: "100%", textAlign: "center", fontSize: "18px" }}
//                               >
//                                 No video found...
//                               </span>
//                             )}

//                             <NavLink to={`/charity/${item["CharityPool Contract"]}`} className="cta">
//                               Details
//                             </NavLink>

//                             <div style={{ height: "120px", overflow: "hidden" }}>
//                               <p className="kseDescription">{item["Short Description for Front of Card"]}</p>
//                             </div>

//                             <div className="full">
//                               <p className="name">Operating In:</p>
...
//                                                     */}
//                             <div className="half">
//                               <p className="name">Total Revenue</p>
//                               <p className="price">{item["Total Revenue"]}</p>
//                             </div>
//                             <div className="half">
//                               <p className="name">Year Founded</p>
//                               <p className="price">{item["Year Incorporated"]}</p>
//                             </div>
//                           </div>
//                         </div>
//                       </div>
...
//                   }
//                 })}
//                 {filteredCharities.length > filteredShownCharities ? (
